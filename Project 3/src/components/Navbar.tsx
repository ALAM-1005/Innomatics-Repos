      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <span className="group-hover:animate-text-shimmer">Shivarth Portfolio</span>
          </Link>
          ...
          >
            <div className="flex flex-col h-full p-8">
              ...
              >
                ...
                <p className="mt-2">Contact me at: <span className="text-primary">shivarth.drona@gmail.com</span></p>
              </motion.div>
            </div>
          </motion.div>
        )}
