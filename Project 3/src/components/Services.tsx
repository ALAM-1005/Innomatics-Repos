    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="section-title text-black" >Services I Offer</h2>
        ...
        <div className="mt-16 bg-primary rounded-lg p-8 text-center">
          ...
          <a
            href="#contact"
            className="inline-block bg-white px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors duration-300 text-black"
          >
            Get in Touch
          </a>
        </div>
