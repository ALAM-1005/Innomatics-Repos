        ...
        >
          <div className="order-2 lg:order-1">
            ...
            >
              ...
              <a href="https://drive.google.com/file/d/1Hs-MsLhZHKtqK-aVWIfsFg_cV9hoYXTn/view?usp=drive_link" target='blank' className="btn btn-outline border-primary text-primary hover:bg-primary hover:text-white neon-box">
            ...
            >
              ...
              <div className="typing-animation">
                <span className="text-green-400">$</span> <span className="text-blue-400">const</span> developer <span className="text-blue-400">=</span> <span className="text-yellow-400">new</span> <span className="text-green-400">Developer</span>(<span className="text-orange-400">'shivarth D'</span>);
                <br />
            ...
            <div className="relative">
              ...
              >
                <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="50" cy="50" r="45" fill="none" stroke="#0ea5e9" strokeWidth="1.5" />
              ...
              >
                <div className="w-60 h-60 md:w-72 md:h-72 animate-morph bg-gradient-to-br from-primary to-secondary p-1">
                  <img
                    src="https://images.pexels.com/photos/30997278/pexels-photo-30997278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                    alt="Profile"
